...
class test extends Admin_Controller
{
    ...
    var $mailchimp = new Mailchimp('56ec508114429503a18b2b2ca81cc7ca-us16');
    ...
    public function suscribeSomeone (){
        
        $list_id = 'b9311ae58b';
        
        $result = $mailchimp->post("lists/$list_id/members", [
                'email_address' => 'ejemplo@suscriptor.com',
                'status'        => 'subscribed',
        ]);
    ...
    public function getCustomers ()
    {
        ...
        foreach ($query->result() as $row) {
            ...
            $row_array['text'] = utf8_encode($row->first_name);
