...
class User extends Admin_Controller {
	...
	public function index()
	{
		...
		$crud->columns('groups', 'email', 'first_name', 'last_name', 'active','last_login');
		...
		$crud->fields('first_name', 'last_name', 'active','last_login','groups');
		
		$crud->field_type('groups', 'password');
