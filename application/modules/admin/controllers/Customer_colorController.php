...
class Customer_colorController extends Admin_Controller {
    ...
    {
        $crud = $this->generate_crud('customers_color');
        
        $crud->columns( 'customer_id','description','last_update');
        
        // translations
        //$crud->display_as('groups','Grupos');
//         //$crud->display_as('username','Usuarios');
...
//         $crud->display_as('phone','Teléfono');
         $crud->display_as('last_update','Última visita');
         $crud->display_as('description','Descripción último color');
         $crud->display_as('customer_id','Nombre cliente');
        
        //$crud->fields('first_name', 'last_name', 'email','phone', 'active','last_login','description');
        
        //$crud->field_type('description', 'enum');
        $crud->set_relation('customer_id','customers','{first_name} {last_name}');
