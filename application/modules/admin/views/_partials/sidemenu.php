...
<li class="header">MAIL</li>
	...
	<?php foreach ($mail_customer as $parent => $parent_params): ?>
...
<li class="header">NAVEGACION PRINCIPAL</li>
	...
	<?php if ( !empty($menu_marketing) ): ?>
		
	<li class="header">MARKETING</li>

	<?php foreach ($menu_marketing as $parent => $parent_params): ?>
	...
	<?php if ( !empty($useful_links) ): ?>
		<li class="header">LINKS DE INTERES</li>
