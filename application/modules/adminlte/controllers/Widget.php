...
class Widget extends MX_Controller {
	...
	function dashboard_info_box($value_1, $label_1, $value_2, $label_2, $value_3, $label_3, $value_4,$label_4)
	{
	    $data = array(
	        'value_1'	=> $value_1,
	        'label_1'  	=> $label_1,
	    ...
	    $this->load->view('widget/dashboard_info_box', $data);
	}
	...
	function map_box()
	{
	    ...
	    $this->load->view('widget/map_box', $data);
	}
	
	function lastest_orders_box()
	{
	    $data = array(
	    );
	    $this->load->view('widget/lastest_orders_box', $data);
	}
