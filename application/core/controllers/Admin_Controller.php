...
class Admin_Controller extends MY_Controller {
	...
	public function __construct()
	{
		...
		$this->menu_marketing = $this->mConfig['menu_marketing'];
		$this->mail_customer = $this->mConfig['mail_customer'];
	}
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		$this->mViewData['menu_marketing'] = $this->menu_marketing;
		$this->mViewData['mail_customer'] = $this->mail_customer;
	...
	// Render CRUD
	protected function render_crud($pageType = '')
	{
